...
//   //    supplier=false;
//   //    managesales=false;
//   //   document.getElementById("changetodashboard").classList.add("active"); 
//   // } 
//   document.getElementById("changetodashboard").classList.add("active"); 
//   document.getElementById("changetopossales").classList.remove("active"); 
//   document.getElementById("changetotable").classList.remove("active");
//   document.getElementById("changetopurchase").classList.remove("active");
//   document.getElementById("changetosupplier").classList.remove("active");
//   document.getElementById("changetomanagesales").classList.remove("active");    
// }

// function possalesisactive(e) 
// { 
//   e.preventDefault();
//   document.getElementById("changetopossales").classList.add("active");
//   document.getElementById("changetodashboard").classList.remove("active");  
//   document.getElementById("changetotable").classList.remove("active");
//   document.getElementById("changetopurchase").classList.remove("active");
//   document.getElementById("changetosupplier").classList.remove("active");
//   document.getElementById("changetomanagesales").classList.remove("active");    
...
// { 
//   document.getElementById("changetotable").classList.add("active");
//   document.getElementById("changetopossales").classList.remove("active");
//   document.getElementById("changetodashboard").classList.remove("active");  
//   document.getElementById("changetopurchase").classList.remove("active");
//   document.getElementById("changetosupplier").classList.remove("active");
