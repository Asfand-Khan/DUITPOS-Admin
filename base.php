...
<head>
  ...
  <title>DUITPOS - Admin Dashboard</title>
  <!-- General CSS Files -->
  ...
  <!-- Font Awesome Icons -->
  <script src="https://kit.fontawesome.com/ca336a6633.js" crossorigin="anonymous"></script>
</head>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              <a href="possales.html" class="nav-link"><i class="fas fa-regular fa-store"></i><span>POS (Sales)</span></a>
            </li>
            <li class="dropdown">
              <a href="table.html" class="nav-link"><i class="fas fa-table"></i><span>Table</span></a>
            </li>
            <li class="dropdown">
              <a href="purchase.html" class="nav-link"><i class="fas fa-regular fa-basket-shopping"></i><span>Purchase</span></a>
            </li>
            <li class="dropdown">
              <a href="product.html" class="nav-link"><i class="fas fa-regular fa-box"></i><span>Product</span></a>
            </li>
            <li class="dropdown">
              <a href="supplier.html" class="nav-link"><i class="fas fa-boxes-packing"></i><span>Supplier</span></a>
            </li>
            <li class="dropdown">
              <a href="managesales.html" class="nav-link"><i class="fas fa-list-check"></i><span>Manage Sales</span></a>
            </li>
          </ul>
        </aside>
      </div>
